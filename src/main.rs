...
use embassy_rp::{
    bind_interrupts,
    i2c::{self, Config, I2c, InterruptHandler},
    peripherals::I2C1,
};
...
async fn rtc_task(
    mut rtc: Ds323x<I2cInterface<I2c<'static, I2C1, embassy_rp::i2c::Async>>, DS3231>,
) {
    loop {
        let time = rtc.time();
...
async fn main(spawner: Spawner) {
    ...
    let rtc: Ds323x<I2cInterface<I2c<'_, I2C1, embassy_rp::i2c::Async>>, DS3231> =
        ds323x::Ds323x::new_ds3231(i2c);

    // let led=DisplayDriver::new()
